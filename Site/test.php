...
//define variables
                                        if (isset($_POST["submit"])) {
                                            ...
                                            $result = mysqli_query($conn,"SELECT email, password FROM customer where id=1");
                ...
                <div class="col-sm-4">
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <form action="#">
                            ...
                            <input type="text" name="SAddress" placeholder="Shipping Address"/>
                            <input type="text" name="Phone" placeholder="Phone"/>
                            <input type="email" placeholder="Email Address"/>
                            <input type="password" placeholder="Password"/>
                            <input type="passwprd" placeholder="ConfirmPassword"/>
